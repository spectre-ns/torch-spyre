...
class TestDimHintsToTileSpec(unittest.TestCase):
    ...
    def test_round_trips_through_the_lowering(self):
        ...
        for op, spec in [
            ...
            (red, TileSpec((TileAxis(1, 4, is_reduction=True),))),
            (red, TileSpec((TileAxis(3, 2, is_reduction=True),))),
        ]:
