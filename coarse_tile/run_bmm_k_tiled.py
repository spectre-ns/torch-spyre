...
"""Standalone: 3D bmm K-tiled.

Mirrors test_bmm_k_tiled_correct in test_coarse_tile_e2e.py.

torch.bmm([B,M,K] @ [B,K,N]) tiled over the K (reduction) dimension.
Shapes: B=8, M=64, K=512, N=32.

Usage:
    python3 tests/inductor/standalone/run_bmm_k_tiled.py
"""
