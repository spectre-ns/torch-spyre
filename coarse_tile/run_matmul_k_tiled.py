...
"""Standalone: matmul K-tiling (reduction dim).

Mirrors test_hint_tiled_reduction_matmul_correct in test_coarse_tile_e2e.py.

spyre_hint(num_tiles_per_dim={"K": 4}) tiles [M,K] @ [K,N] over the K
(reduction) dimension.  Shapes: M=64, K=512, N=32.
K/T=128 elements = 2 sticks at fp16; shapes are stick-aligned without padding.

Usage:
    python3 tests/inductor/standalone/run_matmul_k_tiled.py
"""
