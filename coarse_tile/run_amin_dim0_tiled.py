...
"""Standalone: x.amin(dim=0) tiled over B.

Mirrors test_hint_tiled_reduction_dim0_min_correct in test_coarse_tile_e2e.py.

Reduces a [B, D] tensor to the element-wise min over B (dim=0).
spyre_hint(num_tiles_per_dim={"B": 4}).

Usage:
    python3 tests/inductor/standalone/run_amin_dim0_tiled.py
"""
